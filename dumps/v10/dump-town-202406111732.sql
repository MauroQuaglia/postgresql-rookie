...
--
-- Name: pglog; Type: FOREIGN TABLE; Schema: school; Owner: postgres
--

CREATE FOREIGN TABLE school.pglog (
    user_name text,
    database_name text,
    query_id bigint
)
SERVER pglog
OPTIONS (
    filename '/var/log/postgresql/pg_log/postgresql.csv',
    format 'csv'
);


ALTER FOREIGN TABLE school.pglog OWNER TO postgres;
